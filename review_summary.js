  document.addEventListener('DOMContentLoaded', function() {
    ...
    function createReviewsSummary(data) {
      ...
      for (let i = 5; i >= 1; i--) {
        ...
        stars.innerHTML = `${i} ` + '⭐'.repeat(i); // Include the number before the stars
      ...
      // Insert the reviews summary into the page
    ...
    // Fetch the data from the API and create the reviews summary
